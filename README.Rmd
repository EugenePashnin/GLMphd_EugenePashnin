...
The materials (slides, exercises, code, etc.) are constantly updated. Check the current version of the materials to have the most up-to-date version.
...
make_slide_index(exclude = c("extra", "poisson", "gamma")) |> 
